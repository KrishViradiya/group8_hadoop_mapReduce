...
def main():
    ...
    parser.add_argument("--a2a-jar", default=os.path.join(os.path.dirname(__file__), "jars", "D:\\Paderborn University\\DSSEgit\\group8_hadoop_mapReduce\\jars\\arcade_core_A2a.jar"), help="Path to arcade_core_A2a.jar")
    parser.add_argument("--cvg-jar", default=os.path.join(os.path.dirname(__file__), "jars", "D:\\Paderborn University\\DSSEgit\\group8_hadoop_mapReduce\\jars\\arcade_core_Cvg.jar"), help="Path to arcade_core_Cvg.jar")
    args = parser.parse_args()

    if not args.files:
        args.files = [
            os.path.join("output", "ACDC", "D:\\Paderborn University\\DSSEgit\\group8_hadoop_mapReduce\\output\\ACDC\\mapreduce_ACDC.rsf"),
            os.path.join("output", "LIMBO", "D:\\Paderborn University\\DSSEgit\\group8_hadoop_mapReduce\\final_p&c\\LIMBO\\mapreduceclientcore_algo-limbo_measure-il_serial-50_stop-25.rsf"),
            os.path.join("output", "WCA", "D:\\Paderborn University\\DSSEgit\\group8_hadoop_mapReduce\\final_p&c\\WCA\\mapreduceclientcore_algo-wca_measure-uem_serial-90_stop-75.rsf"),
        ]
